"""
修改了初始化的函数
加上了模型复杂度的参数，可以选择lite模型，提高帧率
模型下载地址：https://google.github.io/mediapipe/solutions/models.html#pose
"""
...
class PoseDetector:
    ...
    def __init__(
        self, mode=False, smooth=True, detectionCon=0.5, trackCon=0.5, complexity=0
    ):
        """
